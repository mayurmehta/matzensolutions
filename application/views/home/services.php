    ...
    <section class="well3 well3__ins1 center991">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 wow fadeInRight" data-wow-delay="0.3s" style="margin-top: 50px;">
            ...
            <!-- <div class="row off1">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    <ul class="marked-list wow fadeInRight">
                        <li><a href="index-2.html#">D & E size color plotting</a></li>
                        <li><a href="index-2.html#">D & E size monochrome plotting</a></li>
                    </ul>
                </div>
            </div>
            <div class="row off1">
                <div class="col-md-5 col-sm-12 col-xs-12 wow fadeInLeft">
                    <h3>Building / Development Permit</h3>
                    ...
                    <p>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor
                        ...
                        in reprehen
                        derit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor sit
                        amet conse ctetur adipisicing elit, sed do eiusmod tempor.</p>
                </div>
                <div class="col-md-3 col-sm-12 col-xs-12">
                    <ul class="marked-list wow fadeIn" data-wow-delay="0.5s">
                        <li><a href="index-2.html#">Code Review & Research</a></li>
                        <li><a href="index-2.html#">Permit Preparation</a></li>
                        <li><a href="index-2.html#">Permit Submittal</a></li>
                    </ul>
                </div>
