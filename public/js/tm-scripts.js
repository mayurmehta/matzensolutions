...
(function($) {
    var o = $('.resp-tabs');
    if (o.length > 0) {
        include('public/js/jquery.responsive.tabs.js');
        $(document).ready(function() {
...
(function($) {
    var o = $('.accordion');
    if (o.length > 0) {
        include('public/js/jquery.ui.accordion.min.js');
        $(document).ready(function() {
            o.accordion({
                active: false,
...
(function($) {
    var o = $('.owl-carousel');
    if (o.length > 0) {
        include('public/js/owl.carousel.min.js');
        $(document).ready(function() {
            o.owlCarousel({
                margin: 30,
                smartSpeed: 450,
...
(function($) {
    include('public/js/mailform/jquery.form.min.js');
    include('public/js/mailform/jquery.rd-mailform.min.js');
})(jQuery);
include('public/js/jquery.cookie.js');
$(document).ready(function() {
...
(function($) {
    var o = $('.thumb');
    if (o.length > 0) {
        include('public/js/jquery.touch-touch.js');
        $(document).ready(function() {
            o.touchTouch();
        });
    }
